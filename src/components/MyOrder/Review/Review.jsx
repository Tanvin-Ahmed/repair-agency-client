                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                ...
                                {errors.rate && <span className="text-danger">This field is required</span>}
                            </div>
                        </div>
                        <textarea placeholder="Review" className="form-control my-2" cols="30" rows="10" {...register("review", { required: true })}></textarea>
