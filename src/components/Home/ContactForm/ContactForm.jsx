            ...
            >
                ...
                <h3 style={{color: 'orangered'}}>Welcome to repair service</h3>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className="form-control my-2" defaultValue={loggedInUser.email} {...register("email")} />
                        <textarea placeholder="Message" className="form-control my-2" {...register("message", { required: true })} cols="30" rows="10"></textarea>
